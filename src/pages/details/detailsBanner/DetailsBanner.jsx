                                    ...
                                    <div className="right">
                                            ...
                                            <div className="info">
                                                ...
                                                <span className="text">
                                                    {director?.map((dir, index) => (
                                                        <span key={index}>
                                                            {dir.name}
                                                            {director.length !== 1 && director.length - 1 !== index && ", "}
                                                        </span>
                                                    ) )}
                                                </span>
                                            </div>
                                            ...
                                            <div className="info">
                                                ...
                                                <span className="text">
                                                    {writer?.map((wri, index) => (
                                                        <span key={index}>
                                                            {wri.name}
                                                            {writer.length !== 1 && writer.length - 1 !== index && ", "}
                                                        </span>
                                                    ) )}
                                                </span>
                                            </div>
                                        ...
                                        {data?.created_by?.length > 0 && (
                                            <div className="info">
                                                ...
                                                <span className="text">
                                                    {data?.created_by?.map((wri, index) => (
                                                        <span key={index}>
                                                            {wri.name}
                                                            {data?.created_by.length !== 1 && data?.created_by.length - 1 !== index && ", "}
                                                        </span>
                                                    ) )}
                                                </span>
                                            </div>
